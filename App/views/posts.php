<?php $this->layout('layout', ['title' => 'Список постов', 'admin' => $admin, 'user' => $user]) ?>
<?php foreach ($posts as $post) { ?>
				<article class="single-blog">
					<div class="post-thumb">
                        <h1>user</h1>
						<a href="#"><img src="assets/upload/<?php echo $post['imglogo']; ?>" alt=""></a>
					</div>
					<div class="post-content">
						...
						<div class="continue-reading text-center text-uppercase">
							<a href="/single-page/<?php echo $post['postid']; ?>">Continue Reading</a>
						</div>
						<div class="post-meta">

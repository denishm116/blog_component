                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav text-uppercase pull-left">
                        ...
                        <li class="dropdown">
                            <?php if ($admin || $user):?>
                            <a href="#" role="button"
                               aria-haspopup="true" aria-expanded="false">Ты <?php echo $_SESSION['auth_username']?></a>
                            <?php else: ?>  <a href="/register" role="button"
                                               aria-haspopup="true" aria-expanded="false">Регистрация</a>
                            <?php endif; ?>
                        ...
                        <?php else: ?>
                        <li class=""><a href="/loginform">вход</a></li>
                        <?php endif; ?>
                        <li class=""></li>
                    </ul>
                </div>
